...
{
    /// <summary>
    /// Представляет коллекцию аудиозаписей.
    /// </summary>
    public class AudiosCollection : StateSupportCollection<VKAudio>, ISupportIncrementalLoading
    {
        private uint _count;
        ...
        public AudiosCollection(long ownerID)
        {
            _ownerID = ownerID;
            HasMoreItems = true;
        }
        ...
        public IAsyncOperation<LoadMoreItemsResult> LoadMoreItemsAsync(uint count)
        {
            return Task.Run(async () =>
            {
                ...
                var request = new GetAudiosRequest { Count = count, Offset = _count, OwnerID = _ownerID };
        ...
        /// <summary>
        /// Выпоняет попытку подгрузить элементы.
        /// </summary>
