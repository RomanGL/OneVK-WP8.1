...
{
    /// <summary>
    /// Представляет коллекцию списков друзей.
    /// </summary>
    public class FriendsListCollection : StateSupportCollection<VKFriendsList>, ISupportIncrementalLoading
    {
        ...
        public FriendsListCollection(ulong userID)
        {
            _userID = userID;
            HasMoreItems = true;
        }
        ...
        public IAsyncOperation<LoadMoreItemsResult> LoadMoreItemsAsync(uint count)
        {
            return Task.Run(async () =>
            {
                ...
                var request = new GetFriendsListsRequest() { UserID = _userID, Count = count, Offset = _count };
