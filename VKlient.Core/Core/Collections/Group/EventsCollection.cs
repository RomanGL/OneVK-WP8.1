...
namespace OneVK.Core.Collections
{
    ...
    /// </summary>
    public class EventsCollection : StateSupportCollection<VKGroupExtended>, ISupportIncrementalLoading
    {
        private ulong _userID;
        private uint _count;
        private uint _totalCount;
        private VKGroupsFilter _filter = VKGroupsFilter.events;
        ...
        public EventsCollection(ulong userID)
        {
            _userID = userID;
            HasMoreItems = true;
        }
