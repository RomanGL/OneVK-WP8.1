...
namespace OneVK.Core.Collections
{
    ...
    /// </summary>
    public class GroupsManageCollection : StateSupportCollection<VKGroupExtended>, ISupportIncrementalLoading
    {
        private ulong _userID;
        private uint _count;
        private uint _totalCount;
        private VKGroupsFilter _filter = VKGroupsFilter.moder;
        ...
        public GroupsManageCollection(ulong userID)
        {
            _userID = userID;
            HasMoreItems = true;
        }
