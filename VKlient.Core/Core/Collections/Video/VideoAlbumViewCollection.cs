...
namespace OneVK.Core.Collections
{
    ...
    /// </summary>
    public class VideoAlbumViewCollection : StateSupportCollection<VKVideoBase>, ISupportIncrementalLoading
    {
        ...
        public VideoAlbumViewCollection(long ownerID, long albumID)
        {
            _ownerID = ownerID;
            _albumID = (ulong)albumID;
            HasMoreItems = true;
        }
        ...
        public IAsyncOperation<LoadMoreItemsResult> LoadMoreItemsAsync(uint count)
        {
            return Task.Run(async () =>
            {
                ...
                var request = new VideoGetRequest() { Count = count, Offset = _count, OwnerID = _ownerID, AlbumID = _albumID };
