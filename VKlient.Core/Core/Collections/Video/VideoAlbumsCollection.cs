...
{
    /// <summary>
    /// Коллекция альбомов видеозаписей.
    /// </summary>
    public class VideoAlbumsCollection : StateSupportCollection<VKVideoAlbumExtended>, ISupportIncrementalLoading
    {
        ...
        public VideoAlbumsCollection(long ownerID)
        {
            _ownerID = ownerID;
            HasMoreItems = true;
        }
        ...
        public IAsyncOperation<LoadMoreItemsResult> LoadMoreItemsAsync(uint count)
        {
            return Task.Run(async () =>
            {
                ...
                var request = new VideoGetAlbumsExtendedRequest() { Count = count, Offset = _count, OwnerID = _ownerID };
