...
namespace OneVK.Controls
{
    ...
    public class StateBlockOld : Control
    {
        ...
        /// </summary>
        public StateBlockOld()
        {
            this.DefaultStyleKey = typeof(StateBlockOld);
        }
        ...
        public static readonly DependencyProperty StateProperty =
            DependencyProperty.Register("State", typeof(ContentState), typeof(StateBlockOld), 
        ...
        {
            ((StateBlockOld)obj).UpdateVisualState();
        }
        #endregion
        ...
        public static readonly DependencyProperty ReloadCommandProperty =
            ...
            typeof(StateBlockOld), new PropertyMetadata(default(ICommand)));        
        #endregion
